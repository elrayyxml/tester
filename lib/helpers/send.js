...
function attachSendHelpers(sock) {
    ...
    sock.groupStatus = function (jid, content, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var options, messageId, contextInfo, prepared, mediaType, mediaSrc, inner, wrapped, msg, priv, relayOpts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = opts || {};
                        ...
                        // neoxr private: { name, emoji }
                        priv = options.private || content.private;
                        if (priv && typeof priv === 'object') {
                            contextInfo.statusAudienceMetadata = {
                                audienceType: priv.audienceType != null ? priv.audienceType : 2,
                                listName: priv.name || priv.listName || '',
                                listEmoji: priv.emoji || priv.listEmoji || ''
                            };
                        }
                    ...
                    case 1:
                        ...
                        if (mediaType === 'video') {
                            ...
                            inner = {
                                imageMessage: Object.assign({}, prepared.imageMessage || prepared, {
                                    caption: content.caption || '',
                                    contextInfo: contextInfo
                                })
                            };
                    ...
                    case 3:
                        ...
                        // optional: some forks need meta is_vsn2=1
                        if (options.vsn2 !== false && options.additionalNodes !== null) {
