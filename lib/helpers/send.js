...
function attachSendHelpers(sock) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        media = options.media;
                        // media: { location: { degreesLatitude, degreesLongitude, name, jpegThumbnail } }
                        if (media && typeof media === 'object' && media.location) {
                            loc = media.location;
                            thumb = loc.jpegThumbnail || loc.thumbnail;
                            thumbBuf = undefined;
                            if (thumb) {
    ...
    sock.sendProduct = function (jid, product, quoted, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var options, q, contextInfo, messageId, productImageMessage, prepared, price, productNode, content, msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = opts || {};
                    ...
                    case 2:
                        ...
                        productNode = {
                            productMessage: {
                                product: {
                                    ...
                                    retailerId: String(product.retailerId || product.retailer || ''),
                                    url: product.url || '',
                        ...
                        if (Object.keys(contextInfo).length) {
                            productNode.productMessage.contextInfo = contextInfo;
                        }
                        // Use FromContent — generateWAMessage does not accept raw productMessage key
                        msg = generateWAMessageFromContent(jid, productNode, {
                            userJid: sock.user && sock.user.id,
                            quoted: (0, context_1.buildQuoted)(q) || undefined,
                            messageId: messageId
                        });
                        return [4 /*yield*/, relay(jid, msg.message || productNode, { messageId: msg.key ? msg.key.id : messageId })];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, msg];
                }
