            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(content.image || content.video || content.audio || content.media || content.sticker)) return [3 /*break*/, 2];
                        if (content.video || content.type === 'video' || options.type === 'video') {
                            mediaType = 'video';
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (isBuf) {
                            ...
                            // url — prepareMedia will upload; skip local thumb
                            inputPath = null;
                        }
                        if (!inputPath) return [3 /*break*/, 2];
                        return [4 /*yield*/, extractVideoThumb(inputPath, '00:00:00', { width: 640, height: 640 }).catch(function () { return null; })];
                    case 1:
                        frameBuf = _a.sent();
                        if (needCleanup)
                    ...
                    case 2:
                        if (!imageInput)
                            imageInput = media.video; // last resort
                        return [4 /*yield*/, prepareMedia(imageInput, 'image', options)];
                    case 3:
                        imgPrepared = _a.sent();
