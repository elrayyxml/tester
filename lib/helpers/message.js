...
function attachSendHelpers(sock) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 , sticker_1.prepareStickerBuffer(sticker, {
                                packname: options.packname || options.pack || options.name || 'Sticker',
                                author: options.author || options.publisher || options.packname || options.pack || 'Sticker',
    ...
    function sendStickerPack(jid, pack, quoted, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var options, q, messageId, name, publisher, packId, stickers, cover, content, msg, results, i, item, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = opts || {};
                        ...
                        cover = pack.cover != null ? normalizeMediaInput(pack.cover) : stickers[0].data;
                        content = {
                            stickerPack: {
                                name: name,
                                publisher: publisher,
                    ...
                    case 4:
                        e_1 = _a.sent();
                        // Baileys without stickerPack / path map → per-sticker with shared EXIF pack
                        results = [];
                        i = 0;
                        _a.label = 5;
                    case 5:
    ...
    (0, airich_1.attachAIRich)(sock, {
        relay: relay,
        makeMsgId: function () { return generic_1.makeMsgId(sock); },
