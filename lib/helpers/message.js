...
function attachSendHelpers(sock) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        messageId = options.messageId || msgid_1.makeMsgId(sock);
    ...
    function sendReact(jid, emoji, key) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        messageId = msgid_1.makeMsgId(sock);
    ...
    function sendStickerPack(jid, pack, quoted, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var options, q, messageId, stickers, cover, content, msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = opts || {};
                        ...
                        sticker_1.ensureStickerPackPaths(baileys);
                        stickers = pack.stickers.map(function (s) {
                            return {
                                data: normalizeMediaInput(s.data || s.url || s.buffer || s),
                                emojis: s.emojis || [],
                                accessibilityLabel: s.accessibilityLabel
                            };
                        });
                        cover = pack.cover != null
                            ? normalizeMediaInput(pack.cover)
                            : stickers[0].data;
                        messageId = options.messageId || msgid_1.makeMsgId(sock);
                        content = {
                            stickerPack: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 , relay(jid, msg.message, {
                                messageId: msg.key.id,
                                additionalNodes: (options && options.additionalNodes) || nodes_1.NODES.poll_creation
                            })];
                    case 2:
                        _a.sent();
                        return [2 , msg];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        messageId = options.messageId || raw.messageId || msgid_1.makeMsgId(sock);
    ...
    async function sendLivePhoto(jid, media, quoted, opts) {
        ...
        await relay(jid, vidContent, { messageId: msgid_1.makeMsgId(sock) });
    ...
    async function sendThumbnailPreview(jid, text, quoted, opts) {
        ...
        var messageId = options.messageId || msgid_1.makeMsgId(sock);
    ...
    (0, airich_1.attachAIRich)(sock, {
        relay: relay,
        makeMsgId: function () { return msgid_1.makeMsgId(sock); },
