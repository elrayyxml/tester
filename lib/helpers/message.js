...
function attachSendHelpers(sock) {
    ...
    function buildInteractiveHeader(options) {
        return __awaiter(this, void 0, void 0, function () {
            var title, media, location, thumbnail, image, prepared, header;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        title =
                        ...
                        if (location) {
                            thumbnail = location.jpegThumbnail || location.thumbnail || location.thumb;
                            ...
                            return [4, prepareMedia(thumbnail, 'image', options)];
                        }
