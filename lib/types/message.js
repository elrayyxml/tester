...
/**
 * Normalize quoted message for Baileys generateWAMessageFromContent.
 * Prevents `Cannot read properties of undefined (reading 'fromMe')` when quoted lacks `.key`.
 * @param {*} quoted
 * @returns {object|undefined}
 */
export function normalizeQuoted(quoted) {
    if (!quoted || typeof quoted !== 'object') return undefined;
    if (!quoted.key || typeof quoted.key !== 'object') return undefined;
    return quoted;
}
